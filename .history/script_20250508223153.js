 ...
 * @property {boolean} public - Whether the bucket is public
 * @property {string[]} allowedMimeTypes - Allowed MIME types
 * @property {number} fileSizeLimit - File size limit in bytes
 */
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    const initSupabase = async () => {
        try {
            ...
            // @ts-ignore
            if (window.UNDERWEB && window.UNDERWEB.common && window.UNDERWEB.common.initSupabase) {
                console.log('Using common.js implementation for Supabase initialization');
                // @ts-ignore
                supabaseClient = await window.UNDERWEB.common.initSupabase();
            ...
            // Fallback if common.js is not loaded or failed
                ...
                console.log('Initializing Supabase client directly...');
